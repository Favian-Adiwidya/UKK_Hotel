...
module.exports = (sequelize, DataTypes) => {
  class detail_pemesanan extends Model {
    ...
    static associate(models) {
      ...
      this.belongsTo(models.customer,{foreignKey:'id_customer'});
      this.belongsTo(models.pemesanan,{foreignKey:'id_pemesanan'});
      this.belongsTo(models.kamar,{foreignKey:'id_kamar'});
    }
  }
